...
var migrations = []string{
	...
	`INSERT OR IGNORE INTO settings (skey, svalue) VALUES ('backup_age_recipient', '')`,
	`INSERT OR IGNORE INTO settings (skey, svalue) VALUES ('backup_age_identity', '')`,
	...
	`INSERT OR IGNORE INTO settings (skey, svalue) VALUES ('backup_auto_enabled', 'false')`,
	`INSERT OR IGNORE INTO settings (skey, svalue) VALUES ('backup_frequency', 'weekly')`,
	`INSERT OR IGNORE INTO settings (skey, svalue) VALUES ('backup_email_enabled', 'false')`,
	`INSERT OR IGNORE INTO settings (skey, svalue) VALUES ('backup_keep_count', '10')`,
	`INSERT OR IGNORE INTO settings (skey, svalue) VALUES ('backup_max_email_mb', '20')`,
	`INSERT OR IGNORE INTO settings (skey, svalue) VALUES ('backup_last_run_at', '')`,
	`INSERT OR IGNORE INTO settings (skey, svalue) VALUES ('backup_last_status', '')`,
	`INSERT OR IGNORE INTO settings (skey, svalue) VALUES ('backup_last_error', '')`,
